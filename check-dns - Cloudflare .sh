...
$testDomain = "speed.cloudflare.com"
...
$dnsProviderList = ("Current P",$currentDNS.ServerAddresses[0]),
            ...
            ("Electro P","78.157.42.100"),
			("Electro A","78.157.42.101"),

			("Download A","129.250.35.250"),
			("Download B","129.250.35.251"),

			("Unknown","0.0.0.0"),
			
			("Cloudflare P","1.1.1.1"),
			("Cloudflare A","1.0.0.1"),
          	        ("Cloudflare Pesonal A","172.64.36.1"),
            		("Cloudflare Pesonal B","172.64.36.2"),
